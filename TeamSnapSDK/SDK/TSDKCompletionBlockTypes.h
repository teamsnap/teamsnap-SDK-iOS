...
typedef void (^TSDKUploadProgressBlock)(BOOL success, BOOL complete, NSNumber *_Nonnull totalSent, NSNumber *_Nonnull totalExpectedToSend, NSError *_Nullable error);
