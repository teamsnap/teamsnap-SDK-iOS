...
typedef void (^TSDKMessagesDatumArrayCompletionBlock)(BOOL success, BOOL complete, NSArray <TSDKMemberMessageDatum *> * _Nullable messageDatums, NSError *_Nullable error);
