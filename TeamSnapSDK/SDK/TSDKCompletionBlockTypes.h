...
typedef void (^TSDKBatchInvoiceAggregateCompletetionBlock)(BOOL success, BOOL complete, TSDKBatchInvoicesAggregate *_Nullable invoiceAggregate, NSError * _Nullable error);
typedef void (^TSDKBatchInvoicesArrayCompletetionBlock)(BOOL success, BOOL complete, NSArray<TSDKBatchInvoice *> *_Nullable invoices, NSError * _Nullable error);
