...
typedef void (^TSDKApnDevicesArrayCompletionBlock)(BOOL success, BOOL complete, NSArray <TSDKApnDevices *> *_Nonnull apnDevices, NSError *_Nullable error);
