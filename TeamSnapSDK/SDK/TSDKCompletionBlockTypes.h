...
typedef void (^TSDKHealthCheckQuestionnaireArrayCompletionBlock)(BOOL success, BOOL complete, NSArray<TSDKHealthCheckQuestionnaire *>*_Nullable healthChecks, NSError *_Nullable error);
typedef void (^TSDKHealthCheckQuestionnaireTemplateArrayCompletionBlock)(BOOL success, BOOL complete, NSArray<TSDKHealthCheckQuestionnaireTemplate *>*_Nullable healthChecks, NSError *_Nullable error);
