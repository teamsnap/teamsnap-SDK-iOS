...
@property (nonatomic, strong) NSDate *_Nullable membersUpdated;
@property (nonatomic, strong) NSDate *_Nullable eventsUpdated;

@property (weak, nonatomic) NSTimeZone *_Nullable timeZone;
@property (weak, nonatomic) TSDKPlan *_Nullable plan;
...
- (void)addEvent:(TSDKEvent *_Nonnull)event;
- (void)addMember:(TSDKMember *_Nonnull)member;
