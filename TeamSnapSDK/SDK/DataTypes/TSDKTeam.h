...
- (instancetype _Nullable)initWithName:(NSString *_Nonnull)name locationCountry:(NSString *_Nonnull)locationCountry locationPostalCode:(NSString *_Nullable)locationPostalCode ianaTimeZoneName:(NSString *_Nullable)ianaTimeZoneName sportId:(NSString *_Nonnull)sportId createTeamPlan:(NSString * _Nonnull)createTeamPlan;
