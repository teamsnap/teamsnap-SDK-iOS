...
@property (nonatomic, strong) NSString *_Nullable gameReminderPreference; //Example: none
@property (nonatomic, strong) NSString *_Nullable eventReminderPreference; //Example: member
...
@property (nonatomic, strong) NSString *_Nullable memberId; //Example: 10689385
@property (nonatomic, assign) BOOL facebookPostScores; //Example: 0
@property (nonatomic, strong) NSString *_Nullable scheduleShowFor; //Example: Games and Events
...
@property (nonatomic, strong) NSString *_Nullable facebookPostScoresToPageName; //Example: **NULL**
@property (nonatomic, assign) BOOL mobileSendPushMessages; //Example: 1
@property (nonatomic, strong) NSDate *_Nullable updatedAt; //Example: 2016-08-09T15:45:41Z
@property (nonatomic, assign) BOOL assignmentsHidePast; //Example: 0
@property (nonatomic, strong) NSString *_Nullable facebookPostScoresToPageId; //Example: **NULL**
...
@property (nonatomic, strong) NSString *_Nullable facebookPageAccessToken; //Example: **NULL**
@property (nonatomic, strong) NSDate *_Nullable createdAt; //Example: 2015-01-15T16:54:21Z



@property (nonatomic, strong) NSString *_Nullable teamId; //Example: 859069
