...
@property (nonatomic, weak) NSString *monthlyPriceDescription; //Example: $17.99/month
@property (nonatomic, weak) NSString *name; //Example: Ultra Plan
...
@property (nonatomic, weak) NSString *planType; //Example: ultra
