...
@property (nonatomic) NSInteger minutesToArriveEarly; //Example: 15
@property (nonatomic, weak) NSString *formattedResults; //Example: **NULL**
@property (nonatomic) NSInteger repeatingTypeCode; //Example: 2
@property (nonatomic, weak) NSDate *startDate; //Example: 2015-08-05T22:30:00Z
@property (nonatomic) NSInteger doesntCountTowardsRecord; //Example: 0
...
@property (nonatomic) NSInteger gameTypeCode; //Example: 0
