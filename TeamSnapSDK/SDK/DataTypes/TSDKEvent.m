...
@dynamic uniform, teamId, iconColor, formattedTitle, opponentId, createdAt, isGame, label, gameType, shootoutPointsForTeam, shootoutPointsForOpponent, timeZoneDescription, tracksAvailability, locationName, isCanceled, sourceTimeZoneIanaName, divisionLocationId, additionalLocationDetails, endDate, isTbd, resultsUrl, isLeagueControlled, name, repeatingType, isShootout, opponentName, pointsForTeam, locationId, minutesToArriveEarly, formattedResults, repeatingTypeCode, startDate, doesntCountTowardsRecord, timeZone, pointsForOpponent, gameTypeCode, timeZoneOffset, arrivalDate, formattedTitleForMultiTeam, updatedAt, isOvertime, repeatingUuid, results, notes, timeZoneIanaName, durationInMinutes, linkStatisticData, linkCalendarSingleEvent, linkAvailabilities, linkOpponent, linkEventStatistics, linkTeam, linkSuggestedAssignments, linkLocation, linkEventLineups, linkDivisionLocation, linkAssignments, linkAssignmentsTeam;
