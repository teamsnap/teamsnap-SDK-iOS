...
@property (nullable, nonatomic, strong) NSURL *linkMemberPhotoFile;
...
- (NSURL *)linkForMemberPhotoWithHeight:(NSInteger)height width:(NSInteger)width;
- (NSURL *)linkForMemberPhotoWithHeight:(NSInteger)height;
