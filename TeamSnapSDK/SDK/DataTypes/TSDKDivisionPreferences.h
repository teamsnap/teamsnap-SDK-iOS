...
@property (nonatomic, strong) NSString *_Nullable colorSchemeCd; //Example: **NULL**
...
@property (nonatomic, strong) NSString *_Nullable availabilitiesSortOrder; //Example: jersey
@property (nonatomic, strong) NSString *_Nullable availabilityGameCutoff; //Example: **NULL**
...
@property (nonatomic, strong) NSString *_Nullable paypalCurrencyId; //Example: <null>
...
@property (nonatomic, strong) NSString *_Nullable memberSortOrder; //Example: first
@property (nonatomic, assign) BOOL isLeagueControllingSettings; //Example: 0
@property (nonatomic, assign) BOOL isYouth; //Example: 1
@property (nonatomic, strong) NSString *_Nullable canHaveSubdivisions; //Example: **NULL**
...
@property (nonatomic, strong) NSURL *_Nullable linkDivisionLogo;
@property (nonatomic, strong) NSURL *_Nullable linkDivision;
@property (nonatomic, strong) NSURL *_Nullable linkPaypalCurrency;
@property (nonatomic, strong) NSURL *_Nullable linkDivisionLogoThumbnail;
