...
@property (nonatomic, strong) NSString *_Nullable label; //Example: **NULL**
@property (nonatomic, assign) BOOL isHidden; //Example: 0
@property (nonatomic, strong) NSDate *_Nullable createdAt; //Example: 2016-08-25T15:14:40Z
@property (nonatomic, assign) BOOL isInvitable; //Example: 1
@property (nonatomic, strong) NSString *_Nullable invitationState; //Example: new
...
@property (nonatomic, strong) NSString *_Nullable contactId; //Example: 210077327
@property (nonatomic, strong) NSDate *_Nullable updatedAt; //Example: 2017-07-20T23:30:27Z
@property (nonatomic, strong) NSString *_Nullable invitationCode; //Example: 0b79ddef80a8c334333a41a6
@property (nonatomic, strong) NSString *_Nullable teamId; //Example: 859069
@property (nonatomic, strong) NSString *_Nullable email; //Example: skyler.seamans+off@teamsnap.com
@property (nonatomic, strong) NSString *_Nullable memberId; //Example: 22861914
