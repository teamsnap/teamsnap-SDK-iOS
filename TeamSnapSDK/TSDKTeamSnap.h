...
- (void)loginWithOAuthToken:(NSString * _Nonnull)OAuthToken completion:(nullable void (^)(BOOL success, TSDKUser * _Nullable user, NSError  * _Nullable error))completion;
- (void)logout;
